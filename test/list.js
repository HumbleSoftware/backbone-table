...
// Fixations:
var template = require('./list/list.hbs');
var templateFull = require('./list/list-full.hbs');
var templateBody = require('./list/list-body.hbs');
var templateItems = require('./list/list-items.hbs');
