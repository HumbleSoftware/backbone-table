...
module.exports = Backbone.View.extend({
  ...
  constructor: function (options, a) {
  ...
  getRenderData: function () {
    ...
    return {
      ...
      items: (this.itemTemplate || this.itemView) ? false : items.map(this.getItemData)
    };
  },

  render: function () {
    Backbone.View.prototype.render.apply(this, arguments);
    if ((this.itemTemplate || this.itemView) && this.items.length) {
      this.renderItems();
    }
    return this;
  },
  ...
  onCollectionReset: function () {
    if (this.items.length && (this.itemTemplate || this.itemView) && this.hasListBody()) {
      this.renderItems();
    } else {
      this.render();
    }
  ...
  onItemAdd: function (item) {
    if ((this.itemTemplate || this.itemView) && this.hasListBody()) {
